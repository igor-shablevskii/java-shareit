...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getCurrentUserItemRequests(Long userId) {
        return get("", userId);
    }

    public ResponseEntity<Object> getItemRequestsFromAnotherUsers(Long userId, Integer from, Integer size) {
